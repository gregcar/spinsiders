...
const BlogIndex = ({ data, location }) => {
  const siteTitle = data.site.siteMetadata?.title
    return (<Layout location={location} title={siteTitle}>
      <SEO title={siteTitle} />
      <p>
        This blog site was started in September 2008 by <a href="/ruveng">Ruven Gotz</a> and <a href="/gregc">Greg Carnie</a>, two members of the Portals and Collaboration team at <a href="http://www.ideaca.com" target="_blank" rel="noreferrer">Ideaca</a><span className="alert">*</span> in Toronto.  Greg has since transferred from Ideaca’s Toronto office and taken up residence at their Calgary office, and Ruven now works at <a href="http://www.navantis.com/" target="blank" rel="noreferrer">Navantis</a><span className="alert">*</span>.
        </p>
      <p>
